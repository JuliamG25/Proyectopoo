...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String ruc = "1025200419";
            String nombre = "Odio a erick";
            String telefono = "911";
            String direccion = "Tottenham City";
            String razon = "Esto fue hecho con odio hacia mi compañero y un tutorial de 25 videos";
